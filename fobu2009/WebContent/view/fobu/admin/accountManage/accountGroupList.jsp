...
function search(pageNum){	
	...
	$.ajax({
        ...
        dataType: "json",
        url:"/admin/accountManage/initGroup.action",
        ...
        success:function(data, status) {
			var c = "";
			var cHeader = "<tr>"
				+"<td width='50' align='center' bgcolor='e7e7e7' class='tx12B'>No</td>"
				+"<td align='center' bgcolor='e7e7e7' class='tx12B'>정산명칭</td>"
				+"<td width='100' align='center' bgcolor='e7e7e7' class='tx12B'>정산일</td>"
                +"<td width='200' align='center' bgcolor='e7e7e7' class='tx12B'>정산업체</td>"
                +"<td width='100' align='center' bgcolor='e7e7e7' class='tx12B'>정산시작일자</td>"
                +"<td width='100' align='center' bgcolor='e7e7e7' class='tx12B'>정산종료일자</td>"
				+"<td width='100' align='center' bgcolor='e7e7e7' class='tx12B'>정산자</td>"
				+"<td width='100' align='center' bgcolor='e7e7e7' class='tx12B'>엑셀다운</td>"
				+"</tr>";
			var a = 1;  
			...
			if(data.accountGroupList.length == 0){
	            ...
	            $.each(data.accountGroupList, function(index) {
	            	var rowNum = index+1;
	                c += "<tr onclick='rowSelect(this, \""+this.accountSeq+"\");' bgcolor='#FFFFFF' style=cursor:hand;>"
	                  ...
	                  +"<td align='center' >"+this.accountName+" 정산내역</td>"
	      			  ...
	      			  +"<td align='center' >"+this.shopName+"</td>"
                      +"<td align='center' >"+this.accountStartDate+"</td>"
                      +"<td align='center' >"+this.accountEndDate+"</td>"
...
function accountExcelDown(seq){
	...
	document.location.href = "/admin/excel/account_excellist.html?"+paramData;
}
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" valign="bottom" class="tx14B" style="padding-left:10px">▣ 정산그룹목록</td>
  </tr>
</table>
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
