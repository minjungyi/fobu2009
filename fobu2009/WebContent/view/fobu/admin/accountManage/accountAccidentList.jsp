...
function statSave(){	
	...
	$.ajax({
	    ...
	    dataType: "json",
	    url:"/admin/accountManage/saveAccountAccidentStat.action",
...
function search(pageNum){
	...
	$.ajax({
        ...
        dataType: "json",
        url:"/admin/accountManage/initAccident.action",
        beforeSend:function(xhr) {
	            ...
	            $.each(data.accountList, function() {
	               // var a = 1;
	            	...
	            	c += "<tr onclick='rowSelect(this, \""+this.seq+"\");' bgcolor='#FFFFFF' style=cursor:hand;>"
	      			  ...
	      			  +"<td align='center' >"+this.accountAccidentNm+"</td>"
	      			  +"</tr>";
	            	a++;
	            });
	            $("#search_total_order").html(cHeader+c);
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" valign="bottom" class="tx14B" style="padding-left:10px">▣ 정산 후 변경 목록</td>
  </tr>
</table>
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
