...
function viewList(seq){
    ...
    success:function(data, status) {        
        ...
        var cContents = "<tr><td width='700' valign='top' align='center'><table width='98%' border='0' cellspacing='0' cellpadding='0'><tr>"
	    	...
	    	+"<p><select name='memoSel' id='memoSel'><option value='지연통화'>지연통화</option><option value='품절통화'>품절통화</option><option value='통화안됨'>통화안됨</option><option value='품절문자'>품절문자</option><option value='대체문자'>대체문자</option><option value='없는전화'>없는전화</option>"
...
function search(pageNum, eqNum){
	...
	$.ajax({
        ...
        success:function(data, status) {
			...
			var cHeader = "<tr>"
				+"<td width='135' height='23' align='center' bgcolor='e7e7e7' class='tx12B'>발주|입금|취소|취완</td>"
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" valign="bottom" class="tx14B" style="padding-left:10px">▣ 발송보류</td>
  </tr>
</table>
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="135" align="center">
    	...
    	<input type="checkbox" name="checkAllD" id="checkAllD" value="6" onclick="allChk('checkAllD');"></td>
