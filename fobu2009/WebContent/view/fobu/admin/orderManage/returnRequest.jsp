...
function viewList(seq){
    ...
    success:function(data, status) {        
        ...
        var cContents = "<tr><td width='700' valign='top' align='center'><table width='98%' border='0' cellspacing='0' cellpadding='0'><tr>"
	    	...
	    	+"<p><select name='memoSel' id='memoSel'><option value='택배접수'>택배접수</option><option value='반품입고'>반품입고</option><option value='배송비입금'>배송비입금</option><option value='배송비동봉'>배송비동봉</option><option value='반품완료'>반품완료</option>"
...
function search(pageNum, eqNum){
	...
	$.ajax({
        ...
        success:function(data, status) {
			...
			var cHeader = "<tr>"
				+"<td width='40' height='23' align='center' bgcolor='e7e7e7' class='tx12B'>반완</td>"
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" valign="bottom" class="tx14B" style="padding-left:10px">▣ 반품요청</td>
  </tr>
</table>
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="40" align="center">
    	<input type="checkbox" name="checkAllA" id="checkAllA" value="8" onclick="allChk('checkAllA');"></td>
