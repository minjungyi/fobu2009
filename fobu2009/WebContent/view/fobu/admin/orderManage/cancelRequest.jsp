...
function viewList(seq){
    ...
    success:function(data, status) {        
        ...
        var cContents = "<tr><td width='700' valign='top' align='center'><table width='98%' border='0' cellspacing='0' cellpadding='0'><tr>"
	    	...
	    	+"<p><select name='memoSel' id='memoSel'><option value='품절통화'>품절통화</option><option value='취소통화'>취소통화</option><option value='취소완료'>취소완료</option><option value='카드취소'>카드취소</option><option value='환불완료'>환불완료</option>"
...
function search(pageNum, eqNum){
	...
	$.ajax({
        ...
        success:function(data, status) {
			...
			var cHeader = "<tr>"
				+"<td width='95' height='23' align='center' bgcolor='e7e7e7' class='tx12B'>신규|취완</td>"
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" valign="bottom" class="tx14B" style="padding-left:10px">▣ 취소요청</td>
  </tr>
</table>
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
