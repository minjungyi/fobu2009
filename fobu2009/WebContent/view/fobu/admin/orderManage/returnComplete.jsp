...
function search(pageNum, eqNum){
	...
	$.ajax({
        ...
        success:function(data, status) {
			...
			var cHeader = "<tr>"
				+"<td width='40' height='23' align='center' bgcolor='e7e7e7' class='tx12B'>반품</td>"
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" valign="bottom" class="tx14B" style="padding-left:10px">▣ 반품완료</td>
  </tr>
</table>
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="40" align="center">
    	<input type="checkbox" name="checkAllA" id="checkAllA" value="7" onclick="allChk('checkAllA');"></td>
