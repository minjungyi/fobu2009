...
<table width="1200" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="d9d9d9">
	<tr>
  	...
  	<tr>
    	...
    	<td height="23" align="center" bgcolor="e7e7e7" class="tx12B">매장재고</td>
    	<td bgcolor="#FFFFFF">
    		<span style="padding : 1 0 3 0">
  	...
  	<tr>
		...
		<td colspan="2" rowspan="2" align="center" bgcolor="#FFFFFF" class="tx12B">
			<img src="<c:out value="${titleImgPath}"/>/<c:out value="${listProductDetail[0].titleImageFile}"/>" width="100" height="100" id="imgTitle"/>
		</td>
	</tr>
	<tr>	
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td height="40" align="center" class="tx14B" style="padding-left:10px">
			...
			<a href="product_list.html" ><img src="/images/button/btn_cancel.gif"></a>
		</td>
	</tr>
</table>
