...
function search(pageNum){
	...
	$.ajax({
        ...
        dataType: "json",
        url:"/admin/statisticsManage/initDaily.action",
        ...
        success:function(data, status) {
            ...
            var totalPage = Math.ceil(parseInt(data.statisticsDailyCount)/parseInt(listScale));
            $("#spanCount").empty().append("전체 "+data.statisticsDailyCount+" 개 : "+pageNum+" / "+totalPage+" 페이지")
...
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="28" valign="bottom" class="tx14B" style="padding-left:10px">▣ 일별통계</td>
  </tr>
</table>
<table width="1200" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
