...
<table width="780" border="0" align="center" cellspacing="1" bgcolor="d2d2d2">
  <tr>
    <td width="25%" align="center">품명/모델명(구성/색상/종류) </td>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="d2d2d2">
      <tr>
        ...
        <td width="245" bgcolor="#FFFFFF">정보불러오기(사진참조)</td>
        <td width="164" bgcolor="#FFFFFF">제품소재/재질</td>
        <td width="238" bgcolor="#FFFFFF">상세정보 별도표기(정보누락 시 추후제공)</td>
      </tr>
      <tr>
		...
		<table width="745" border="0" cellspacing="0" cellpadding="0">
			...
			<c:choose>
				...
				<c:set var="count" value="1" />
					...
					<tr>
						<td><!--카테고리 타이틀 start -->
						<table width="745" border="8" align="center" cellpadding="0"
							cellspacing="0" bordercolor="f9d8d3">
							<tr>
				...
				<c:if test="${count == 4 || count == 8 || count == 12 || count == 16}">
					</tr>
					<tr>
			        	<td>&nbsp;</td>
			            <td>&nbsp;</td>
